...
--
-- Name: bands; Type: TABLE; Schema: public; Owner: Blake
--
...
ALTER TABLE bands OWNER TO "Blake";

--
-- Name: bands_id_seq; Type: SEQUENCE; Schema: public; Owner: Blake
--
...
ALTER TABLE bands_id_seq OWNER TO "Blake";

--
-- Name: bands_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Blake
--
...
--
-- Name: venues; Type: TABLE; Schema: public; Owner: Blake
--
...
ALTER TABLE venues OWNER TO "Blake";

--
-- Name: venues_id_seq; Type: SEQUENCE; Schema: public; Owner: Blake
--
...
ALTER TABLE venues_id_seq OWNER TO "Blake";

--
-- Name: venues_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Blake
--
...
--
-- Data for Name: bands; Type: TABLE DATA; Schema: public; Owner: Blake
--
...
--
-- Data for Name: venues; Type: TABLE DATA; Schema: public; Owner: Blake
--
...
--
-- Name: bands_pkey; Type: CONSTRAINT; Schema: public; Owner: Blake
--
...
--
-- Name: venues_pkey; Type: CONSTRAINT; Schema: public; Owner: Blake
--
